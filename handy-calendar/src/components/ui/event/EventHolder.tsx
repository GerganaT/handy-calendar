...
const EventHolder = ({
  ...
  return (
    <div
      ...
      className={`${
        !showCategoryColorCircle ? eventTypeColor : ""
      } flex items-center w-2/3 p-1 hover:bg-gray-100 hover:rounded-lg hover:cursor-pointer`}
    >
      {showCategoryColorCircle && (
